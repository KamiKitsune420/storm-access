...
int __stdcall NS4Framework::Main()
{
	...
	// Initialize the screen-reader accessibility layer (loads Tolk)
	moddingApi::Accessibility::Initialize();
...
void NS4Framework::Update()
{
	...
	// Poll controller for accessibility shortcuts / navigation gating
	moddingApi::Accessibility::Update();
